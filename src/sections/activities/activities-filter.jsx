...
export const CATEGORY_OPTIONS = ['Consultée', 'Payée', 'Reservée', 'Rejetée'];
...
export default function ActivitiesFilter() {
  ...
  const renderStatus = (
    <Stack spacing={1}>
      <Typography variant="subtitle2">Choisir l'état</Typography>
      <RadioGroup>
  ...
  const renderFactorier = (
    <Stack spacing={1}>
      <Typography variant="subtitle2">choisir un factorier</Typography>
      <RadioGroup>
